...
public class AliDayunSms {
    ...
    public static void main(String[] args) throws ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI5tKVEp2yLkHfPnfMnFdZ";//你的accessKeyId
        final String accessKeySecret = "D0SQxyXQwp0idqAfMcu6Vjerh3rONf";//你的accessKeySecret
        ...
        request.setMethod(MethodType.POST);
              ...
              request.setPhoneNumbers("13706988003");
              //必填:短信签名-可在短信控制台中找到
